...
.ticker-bar-bottom{margin-top:32px;border-bottom:none;border-top:1px solid var(--glow-border)}
...
// 滚动行情条
(function(){
  const stocks = DATA.stocks.slice().sort((a,b) => Math.abs(b.change) - Math.abs(a.change));
