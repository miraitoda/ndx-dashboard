...
.chart-summary{margin-top:14px;padding:12px 16px;border-radius:10px;background:var(--surface);border-left:3px solid var(--glow-color);font-size:13px;line-height:1.6;color:var(--text-secondary);font-weight:500}
...
要求：80-120字，第一句点明大盘情绪，第二句行业分化，第三句龙头表现，第四句展望。不要"根据数据"等机械表达。"""
...
要求：60-100字，分析权重股对指数的拉动/拖累，指出是否有异常异动个股。不要机械表达。"""
...
要求：60-100字，分析资金从哪些板块流出、流入哪些板块。不要机械表达。"""
...
要求：60-100字，判断市场是普涨/普跌还是分化，指出极端情绪信号。不要机械表达。"""
...
要求：60-100字，指出哪些行业有结构性机会、哪些需回避。不要机械表达。"""
...
要求：60-100字，判断是上升趋势/下降趋势/区间震荡，指出支撑/压力或关键变盘信号。不要机械表达。"""
